...
resultado_estagio_1, resultado_estagio_2, guardaengrenagem1, guardaengrenagem2 = eng.dimensionamento_engrenagens_com_vida(
    T_in_Nmm, parametros['rotacao_motor'], i_estagio, eta_estagio, S_at, S_ac, C_p, vida_util_horas
)
...
with open("Outputs/Estagios_Engrenagem.txt", "w") as f:
    f.write(f"Torque de Entrada: {T_in_Nmm/1000:.2f} N.m\n Torque de Saida: {T_out_Nmm/1000:.2f} N.m\n")
    ...
    if resultado_estagio_1 and resultado_estagio_2:
        ...
        f.write(f"  Torque eixo2: {resultado_estagio_1['T_p_out']/1000:.2f} N.m\n")
        ...
        f.write(f"  Torque eixo3: {resultado_estagio_2['T_p_out']/1000:.2f} N.m\n")
